...
#
java "-${MAX_HEAP_SIZE_FLAG}" -Djava.library.path=bazel-bin/eflect_rapl/src/main/native -jar bazel-bin/experiments/main/java/flora/experiments/sunflow/renderer/Evaluator_deploy.jar > "${DATA_DIR}/default-cornell-box.txt"
